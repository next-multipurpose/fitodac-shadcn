		...
		<div className="rounded-lg border bg-muted/50 p-4">
			<div className="flex items-start gap-3">
				...
				<div className="flex min-w-0 flex-1 flex-col gap-2">
					<p className="text-sm font-medium wrap-break-word">2FA is active</p>
	...
	return (
		<div className="flex flex-col gap-3">
			<div className="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
				<div className="min-w-0 flex-1">
					<h3 className="text-sm font-medium wrap-break-word">Backup codes</h3>
					<p className="text-xs wrap-break-word text-muted-foreground">
	...
	return (
		<div className="flex flex-col gap-4">
			<div className="min-w-0">
				<h3 className="text-sm font-medium wrap-break-word text-destructive">
...
function QRCodeDisplay({ qrCodeData }: QRCodeDisplayProps) {
	return (
