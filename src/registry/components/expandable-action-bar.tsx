					...
					{items.map((item) => {
						...
						return (
							<motion.button
								...
								transition={ITEM_TRANSITION}
								className={cn(
									"relative isolate inline-flex items-center justify-center overflow-hidden rounded-full font-medium text-muted-foreground transition-[color,background-color] duration-150 ease-out outline-none",
