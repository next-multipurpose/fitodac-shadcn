	...
	(
		...
		return (
			...
			>
				<DateInput
					className={cn(
						"peer inline-flex h-9 w-full items-center overflow-hidden rounded-md border bg-background px-3 py-2 text-sm whitespace-nowrap shadow-black",
						"data-[focus-within]:ring-1 data-[focus-within]:ring-ring data-[focus-within]:outline-none",
