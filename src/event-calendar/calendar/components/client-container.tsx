...
export function ClientContainer({ view, navBar = {} }: IProps) {
	...
	return (
		<div className="overflow-hidden rounded-xl border">
			<CalendarHeader view={view} events={filteredEvents} navBar={navBar} />
			...
			<DndProviderWrapper>
				...
				{view === "year" && (
					<CalendarYearView allEvents={eventStartDates} navBar={navBar} />
				)}
				{view === "agenda" && (
					<CalendarAgendaView
						singleDayEvents={singleDayEvents}
