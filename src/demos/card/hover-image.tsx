...
export default function CardHoverImageDemo() {
	return (
		<Card className="group/card relative h-96 w-full max-w-xs overflow-hidden border-0 p-0!">
			<img
				src="https://picsum.photos/1000/800?random=62"
				alt="Background"
				className="absolute size-full object-cover transition-transform duration-500 group-hover/card:scale-110"
			/>
