...
export default function TableRoundedHeaderDemo() {
  ...
  return (
    <div className="w-full max-w-6xl">
      <Table>
        <TableHeader>
          <TableRow className="border-b-0! bg-muted *:first:rounded-tl-lg *:first:rounded-bl-lg *:last:rounded-tr-lg *:last:rounded-br-lg">
