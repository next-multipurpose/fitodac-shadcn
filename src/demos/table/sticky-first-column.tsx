...
export default function TableStickyFirstColumnDemo() {
  ...
  return (
    <div className="w-full max-w-2xl">
      <Table>
        <TableHeader>
          <TableRow className="border-b-0! bg-muted *:first:rounded-tl-lg *:first:rounded-bl-lg *:last:rounded-tr-lg *:last:rounded-br-lg hover:bg-transparent">
