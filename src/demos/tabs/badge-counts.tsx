...
export default function TabsBadgeCountsDemo() {
  return (
    <Tabs className="w-full max-w-2xl" defaultValue="inbox">
      ...
      <TabsContent value="archived">
        <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <p className="text-muted-foreground text-sm">
            View all your archived messages here. These messages have been moved out of
            your inbox for safekeeping.
          </p>
        </div>
      </TabsContent>
      <TabsContent value="spam">
        <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
          ...
          <p className="text-muted-foreground text-sm">
            Messages identified as spam are automatically moved here. Review them to
            ensure nothing was incorrectly filtered.
          </p>
        </div>
      </TabsContent>
    </Tabs>
