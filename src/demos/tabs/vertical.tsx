...
export default function TabsVerticalDemo() {
  return (
    <Tabs
      className="w-full max-w-2xl flex-row gap-6"
      ...
      <div className="flex-1">
        <TabsContent value="profile">
          <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
            ...
            <p className="text-muted-foreground text-sm">
              Update your profile information including your name, email, and profile
              picture. These details will be visible to other users.
            </p>
          </div>
        </TabsContent>
        ...
        <TabsContent value="team">
          <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
            ...
            <p className="text-muted-foreground text-sm">
              Invite team members, manage permissions, and configure team-wide settings
              and integrations.
            </p>
          </div>
        </TabsContent>
