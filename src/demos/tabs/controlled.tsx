  ...
  return (
    <div className="w-full max-w-2xl space-y-4">
      <Tabs onValueChange={setActiveTab} value={activeTab}>
        ...
        <TabsContent value="step1">
          <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
            <h3 className="mb-2 font-semibold text-lg">Step 1: Basic Information</h3>
        ...
        <TabsContent value="step2">
          <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
            <h3 className="mb-2 font-semibold text-lg">Step 2: Configuration</h3>
            <p className="mb-4 text-muted-foreground text-sm">
            ...
            <div className="space-y-4">
              ...
              <div className="rounded-md border p-4">
                ...
                <p className="mt-1 text-muted-foreground text-sm">Select your build tool</p>
              </div>
            </div>
          </div>
        </TabsContent>
        <TabsContent value="step3">
          <div className="rounded-lg border bg-card p-6 text-card-foreground shadow-sm">
            <h3 className="mb-2 font-semibold text-lg">Step 3: Review & Confirm</h3>
            <p className="mb-4 text-muted-foreground text-sm">
      ...
      <div className="flex justify-between">
        ...
        <Button disabled={activeTab === "step3"} onClick={handleNext} variant="default">
          Next
        </Button>
      </div>
    </div>
