...
export default function FileUploadCompletedFileDemo() {
	return (
		<form>
			...
			<div className="mt-4 flex justify-center space-x-4 rounded-md border border-dashed border-input px-6 py-10">
				<div className="sm:flex sm:items-center sm:gap-x-3">
					<Upload
						className="mx-auto size-8 text-muted-foreground sm:mx-0 sm:h-6 sm:w-6"
						aria-hidden={true}
					/>
			...
			<div className="mt-8 flex items-center justify-end space-x-3">
				<Button
					type="button"
					variant="outline"
					className="rounded-sm border border-input px-4 py-2 text-sm font-medium whitespace-nowrap text-foreground shadow-sm hover:bg-accent hover:text-foreground"
				>
					Cancel
				</Button>
				<Button
					type="button"
					variant="default"
					className="rounded-sm bg-primary px-4 py-2 text-sm font-medium whitespace-nowrap text-primary-foreground shadow-sm hover:bg-primary/90"
				>
					Upload
				</Button>
			</div>
