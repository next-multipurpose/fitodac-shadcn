...
export default function FileUploadImageGridDemo({
	maxFiles = 10,
			...
			<div className="mb-6">
				<div className="grid grid-cols-4 gap-2.5">
					...
					{visibleDefaultImages.map((defaultImg) => (
						<Card
							key={defaultImg.id}
							className="group/item relative flex shrink-0 items-center justify-center rounded-md bg-accent/50 p-0 shadow-none"
						>
							<img
								src={defaultImg.src}
