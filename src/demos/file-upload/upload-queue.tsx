...
export default function FileUploadQueueDemo() {
		...
		<div className="mx-auto flex w-full max-w-sm flex-col gap-y-6">
			...
			<div className="flex flex-col gap-y-4">
				{activeUploads.length > 0 && (
					<div>
						<h2 className="mb-4 flex items-center font-mono text-lg font-normal text-balance text-foreground uppercase sm:text-xs">
								...
								<div key={file.id} className="group flex items-center py-4">
									...
									<div className="mb-1 flex w-full flex-col">
										<div className="flex justify-between gap-2">
											<span className="text-base/6 text-foreground select-none group-disabled:opacity-50 sm:text-sm/6">
												{file.name}
											</span>
