...
export default function CheckboxPaymentMethodDemo() {
	return (
			...
			<FieldLabel htmlFor="mastercard" className="relative p-0!">
				<Field orientation="horizontal">
					...
					<FieldTitle className="flex flex-col items-start gap-4!">
						<div className="flex size-10 items-center justify-center rounded-lg border border-border bg-background p-1.5 shadow-xs shadow-black/5">
