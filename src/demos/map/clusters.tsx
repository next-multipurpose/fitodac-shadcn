...
import { Map, MapClusterLayer, MapPopup, MapControls } from "@/registry/components/map"
...
export default function MapClustersDemo() {
  ...
  return (
    <div className="h-[420px] w-full overflow-hidden rounded-xl border">
      <Map center={[-103.59, 40.66]} zoom={3.4} fadeDuration={0} theme="light">
