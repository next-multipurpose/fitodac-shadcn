...
import { ClockIcon, Loader2Icon, RouteIcon } from "lucide-react"
...
export default function MapOsrmRouteDemo() {
    ...
    <div className="relative h-[500px] w-full overflow-hidden rounded-xl border">
      <Map center={[4.69, 52.14]} zoom={8.5} theme="light">
        ...
        <MapMarker longitude={end.lng} latitude={end.lat}>
          <MarkerContent>
            <div className="size-5 rounded-full border-2 border-white bg-red-500 shadow-lg" />
