...
export default function Component() {
  return (
    <div className="flex flex-col gap-2">
      <Button variant="outline"><span className="me-1 text-[#DB4437] dark:text-white/60"><GoogleMark /></span>Login with Google</Button>
      <Button variant="outline"><span className="me-1 text-[#14171a] dark:text-white/60"><XMark /></span>Login with X</Button>
      <Button variant="outline"><span className="me-1 text-[#1877f2] dark:text-white/60"><FacebookMark /></span>Login with Facebook</Button>
      <Button variant="outline"><span className="me-1 text-[#333333] dark:text-white/60"><GithubMark /></span>Login with GitHub</Button>
    </div>
  )
}
