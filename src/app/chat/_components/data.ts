...
export const conversations: Conversation[] = [
	// Pinned
	{
		...
		preview:
			"We're seeing 502 errors after the latest build went out. Rollback didn't help.",
		time: "Just now",
		isUnread: true,
		isOnline: true,
		unreadCount: 4,
	...
	},
	{
		...
		preview:
			"I was billed twice on the 3rd. Can someone look into this and reverse the duplicate?",
		time: "5m",
		isUnread: false,
		isOnline: true,
		unreadCount: 0,
	...
	},
	{
		...
		preview:
			"I'm getting a 403 since the role update yesterday. Tried clearing cache already.",
		time: "8m",
		isUnread: true,
		isOnline: false,
		unreadCount: 2,
	...
	// Today
	{
		...
		preview:
			"Hi team, I'm looking for the latest ESG disclosure for our upcoming board meeting.",
		time: "10:42 AM",
		isUnread: true,
		isOnline: true,
		unreadCount: 5,
	...
	},
	{
		...
		preview:
			"Tried three times this morning. It gets to about 60% then throws a gateway error.",
		time: "10:15 AM",
		isUnread: false,
		isOnline: false,
		unreadCount: 0,
	...
	},
	{
		...
		preview:
			"Our payment cleared on Friday — screenshot of the confirmation attached here.",
		time: "9:58 AM",
		isUnread: true,
		isOnline: false,
		unreadCount: 1,
	...
	},
	{
		...
		preview:
			"We're winding down the project at end of quarter. Is there an early termination fee?",
		time: "9:12 AM",
		isUnread: false,
		isOnline: false,
		unreadCount: 0,
	...
	},
	{
		...
		preview:
			"Our batch jobs are getting 429s every 15 minutes between 9 and 11 AM. Need a bump.",
		time: "8:47 AM",
		isUnread: true,
		isOnline: true,
		unreadCount: 3,
	...
	},
	{
		...
		preview:
			"Users are seeing certificate warnings when they hit our shop page. This is urgent.",
		time: "8:05 AM",
		isUnread: true,
		isOnline: false,
		unreadCount: 6,
	...
	},
	{
		...
		preview:
			"We're ready to commit for the year. Can you send over the annual pricing sheet?",
		time: "7:38 AM",
		isUnread: false,
		isOnline: true,
		unreadCount: 0,
	...
	},
	{
		...
		preview:
			"Our engineering leads need read-only on production but full write access on staging.",
		time: "5:44 AM",
		isUnread: false,
		isOnline: false,
		unreadCount: 0,
	...
	},
	{
		...
		preview:
			"Three users reported the same crash on launch. Stack trace from Firebase attached.",
		time: "5:18 AM",
		isUnread: true,
		isOnline: false,
		unreadCount: 3,
	...
	},
	{
		...
		preview:
			"Need a 30-minute walkthrough of the vendor portal for our finance leads this Friday.",
		time: "Yesterday",
		isUnread: true,
		isOnline: false,
		unreadCount: 5,
	...
	},
	{
		...
		preview:
			"We're migrating from Okta to Azure AD. What's the typical setup timeline for SSO?",
		time: "Yesterday",
		isUnread: false,
		isOnline: true,
		unreadCount: 0,
