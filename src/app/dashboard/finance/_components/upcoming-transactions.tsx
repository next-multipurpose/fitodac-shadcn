...
import { Item, ItemActions, ItemContent, ItemDescription, ItemGroup, ItemMedia, ItemTitle } from "@/registry/primitives/item";
      ...
      <CardContent className="flex flex-col gap-3">
        ...
        <ItemGroup>
          {transactions.map((transaction) => (
            <Item key={transaction.id} variant="outline" size="sm">
              <ItemMedia>
